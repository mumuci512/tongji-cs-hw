...
set_property PACKAGE_PIN J15 [get_ports {iData[3]}]
set_property PACKAGE_PIN L16 [get_ports {iData[2]}]
set_property PACKAGE_PIN M13 [get_ports {iData[1]}]
set_property PACKAGE_PIN R15 [get_ports {iData[0]}]
