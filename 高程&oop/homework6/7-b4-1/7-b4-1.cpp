...
public:
	...
	double area()
	{
		double p1_x = p1.getx(), p1_y = p1.gety();
		double p2_x = p2.getx(), p2_y = p2.gety();
		double p3_x = p3.getx(), p3_y = p3.gety();
		double a = sqrt((p1_x - p2_x) * (p1_x - p2_x) + (p1_y - p2_y) * (p1_y - p2_y));
		double b = sqrt((p1_x - p3_x) * (p1_x - p3_x) + (p1_y - p3_y) * (p1_y - p3_y));
		double c = sqrt((p3_x - p2_x) * (p3_x - p2_x) + (p3_y - p2_y) * (p3_y - p2_y));
