...
private:
	...
	/* ---------------------------------------------------------------
	   ...
	   ---------------------------------------------------------------- */
	const int print_type() const;
	const int print_range_set() const;
	const int print_default() const;
	const int print_prompt(int type, int range_set, int Default) const;
	int extra_para(const char* const para);
	const int cal_width(u_int& lname, u_int& ltype, u_int& ldefault, u_int& lexists, u_int& lvalue, u_int& lrs, const string* typen) const;
	const int print_form_default(u_int lname, u_int ltype, u_int ldefault, u_int lexists, u_int lvalue, u_int lrs, const string* typen) const;
	const int print_form_value(u_int lname, u_int ltype, u_int ldefault, u_int lexists, u_int lvalue, u_int lrs, const string* typen) const;
	const int print_form_range_set(u_int lname, u_int ltype, u_int ldefault, u_int lexists, u_int lvalue, u_int lrs, const string* typen) const;
	const int print_form(u_int lname, u_int ltype, u_int ldefault, u_int lexists, u_int lvalue, u_int lrs, const string* typen) const;
	char pad[68];
