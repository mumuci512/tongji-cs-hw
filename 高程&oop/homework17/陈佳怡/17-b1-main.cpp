...
//		cout << "s1应为HelloHello!HelloHello!HelloHello!，实际输出：" << (((s1 *= 2) + '!') *= 3) << endl;
	...
	if (1)
	{
		...
		cout << "insert(TStringAdv, int) 测试" << endl;

		cout << "插入位置 1: 应为TongjiHello, 实际输出: " << s1.insert(s2, 1) << endl;

		s1 = "Hello";
		cout << "插入位置 6: 应为HelloTongji, 实际输出: " << s1.insert(s2, 6) << endl;

		//插入越界
		s1 = "Hello";
		cout << "插入位置 0(越界): 应为Hello, 实际输出: " << s1.insert(s2, 0) << endl;
		cout << "插入位置 7(越界): 应为Hello, 实际输出: " << s1.insert(s2, 7) << endl;
	...
	{
		TStringAdv s1 = "Hello";
		const char* str = "Tongji";

		cout << "insert(const char*, int) 测试" << endl;

		// 正确插入
		cout << "插入位置 1: 应为TongjiHello, 实际输出: " << s1.insert(str, 1) << endl;

		// 插入空字符串
		s1 = "Hello";
		cout << "插入空字符串: 应为Hello, 实际输出: " << s1.insert("", 1) << endl;

		s1 = "Hello";
		cout << "插入nullptr: 应为Hello, 实际输出: " << s1.insert(nullptr, 1) << endl;

		s1 = "Tongji";
		cout << "插入尾零到位置4: 应为Ton, 实际输出: " << s1.insert('\0', 4) << endl;

		s1 = "Tongji";
		cout << "插入尾零到位置1: 应为<EMPTY>, 实际输出: " << s1.insert('\0', 1) << endl;
	...
	if (1)
	{
		...
		cout << "插入字符 'W' 到位置 1: 应为WHello, 实际输出: " << s1.insert('W', 1) << endl;
		s1 = "Hello";
		cout << "插入字符 'W' 到位置 3: 应为HeWllo, 实际输出: " << s1.insert('W', 3) << endl;

		s1 = "Hello";
		cout << "插入字符 'W' 到位置 6: 应为HelloW, 实际输出: " << s1.insert('W', 6) << endl;

		//插入越界
		s1 = "Hello";
		cout << "插入位置 0(越界): 应为Hello, 实际输出: " << s1.insert('W', 0) << endl;
		cout << "插入位置 7(越界): 应为Hello, 实际输出: " << s1.insert('W', 7) << endl;
	...
	if (1)
	{
		...
		cout << "substr(int, int) 测试" << endl;

		//正确截取
		cout << "截取从位置 1 长度为 5: 应为Hello, 实际输出: " << s1.substr(1, 5) << endl;

		//截取超长
		cout << "截取从位置 6 长度为 10: 应为World, 实际输出: " << s1.substr(6, 10) << endl;

		//越界截取
		cout << "截取从位置 0(越界): 应为<EMPTY>, 实际输出: " << s1.substr(0, 5) << endl;
		cout << "截取从位置 11(越界): 应为<EMPTY>, 实际输出: " << s1.substr(11, 5) << endl;
	...
	if (1)
	{
		...
		cout << "TStringAdvLen(const TString&) 测试" << endl;

		//测试长度
		cout << "字符串长度: 应为5, 实际输出: " << TStringAdvLen(s1) << endl;
